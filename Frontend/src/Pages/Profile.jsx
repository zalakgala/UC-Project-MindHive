    ...
    const fetchProfile = async () => {
      try {
        ...
        if (response.data.profile_image) {
          setProfileImagePreview(response.data.profile_image.startsWith('http') ? response.data.profile_image : `${api.defaults.baseURL}${response.data.profile_image}`);
        }
      } catch (error) {
  ...
  const handleSave = async () => {
    try {
      ...
      if (res.data.profile_image) {
        setProfileImagePreview(res.data.profile_image.startsWith('http') ? res.data.profile_image : `${api.defaults.baseURL}${res.data.profile_image}`);
